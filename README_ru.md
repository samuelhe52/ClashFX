...
> **🚧 Выйдет с v1.1.0** — канал Lab запускается вместе со следующим релизом. До этого все пользователи остаются на Stable; переключатель ниже становится активным начиная с v1.1.0.
